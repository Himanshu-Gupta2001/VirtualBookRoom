        ...
        <div class="innerdiv">
            ...
            <div id="addbook" class="innerright portion"
                ...
                <form action="addbookserver_page.php" method="post" enctype="multipart/form-data">
                    ...
                    <div>Branch:<input type="radio" name="branch" value="other" />other<input type="radio" name="branch"
                            value="BSIT" />BSIT<div style="margin-left:80px"><input type="radio" name="branch"
                                value="BSCS" />BSCS<input type="radio" name="branch" value="BSSE" />BSSE</div>
                    </div>
